jQuery(document).ready(function($) {
    ...
    // ⚡ Bolt: Debounce the search handler to reduce server requests and improve performance.
    // This waits for the user to stop typing for 300ms before sending the AJAX request.
