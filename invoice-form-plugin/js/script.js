jQuery(document).ready(function($) {
    ...
    // ⚡ Bolt: Debounce the search input to prevent excessive AJAX calls.
    // This improves performance by only sending a request after the user has stopped typing for 300ms.
    var searchTimeout;
