...
jQuery(document).ready(function($) {
    ...
    // By wrapping the AJAX call in a debounce function, we prevent excessive requests
    // from being sent to the server on every keystroke. The request will only be sent
    // after the user has stopped typing for 300ms.
    // Expected Impact: Reduces server load and improves frontend responsiveness during product search.
